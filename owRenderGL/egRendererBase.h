...
#pragma region Typedefs
	...
	typedef uint32(*PFN_CREATETEXTURE)(void* const, TextureTypes::List type, int width, int height, int depth, TextureFormats::List format, bool hasMips, bool genMips, bool compress, bool sRGB);
	...
	typedef uint32(*PFN_CREATESHADER)(void* const, const char *vertexShaderSrc, const char *fragmentShaderSrc, const char *geometryShaderSrc, const char *tessControlShaderSrc, const char *tessEvaluationShaderSrc, const char *computeShaderSrc);
	...
	typedef uint32(*PFN_CREATERENDERBUFFER)(void* const, uint32 width, uint32 height, TextureFormats::List format, bool depth, uint32 numColBufs, uint32 samples);
	...
	typedef bool(*PFN_GETRENDERBUFFERDATA)(void* const, uint32 rbObj, int bufIndex, int *width, int *height, int *compCount, void *dataBuffer, int bufferSize);
...
#pragma region Functions invokers
	...
	template<typename T>
	static void *            mapBuffer_Invoker(void* const pObj, uint32 geoObj, uint32 bufObj, uint32 offset, uint32 size, RDIBufferMappingTypes mapType)
	{
	...
	template<typename T>
	static uint32            createTexture_Invoker(void* const pObj, TextureTypes::List type, int width, int height, int depth, TextureFormats::List format, bool hasMips, bool genMips, bool compress, bool sRGB)
	{
	...
	// shaders
	template<typename T>
	static uint32            createShader_Invoker(void* const pObj, const char *vertexShaderSrc, const char *fragmentShaderSrc, const char *geometryShaderSrc, const char *tessControlShaderSrc, const char *tessEvaluationShaderSrc, const char *computeShaderSrc)
	{
	...
	// Render bufs
	template<typename T>
	static uint32            createRenderBuffer_Invoker(void* const pObj, uint32 width, uint32 height, TextureFormats::List format, bool depth, uint32 numColBufs, uint32 samples)
	{
	...
	template<typename T>
	static bool	             getRenderBufferData_Invoker(void* const pObj, uint32 rbObj, int bufIndex, int *width, int *height, int *compCount, void *dataBuffer, int bufferSize)
	{
	...
	template<typename T>
	static void				 drawIndexed_Invoker(void* const pObj, RDIPrimType primType, uint32 firstIndex, uint32 numIndices, uint32 firstVert, uint32 numVerts)
	{
...
#pragma region Main interface
	...
	uint32 createTexture(TextureTypes::List type, int width, int height, int depth, TextureFormats::List format, bool hasMips, bool genMips, bool compress, bool sRGB)
	{
	...
	// Renderbuffers
	uint32 createRenderBuffer(uint32 width, uint32 height, TextureFormats::List format, bool depth, uint32 numColBufs, uint32 samples)
	{

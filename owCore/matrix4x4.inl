...
Matrix4x4t<T>::operator Matrix4x4t<TOther>() const {
...
// ----------------------------------------------------------------------------------------
template <typename T>
inline Matrix4x4t<T>::Matrix4x4t(const Matrix3x3t<T>& m) {
...
// ----------------------------------------------------------------------------------------
template <typename T>
inline Matrix4x4t<T>::Matrix4x4t(const Vector3t<T>& scaling, const aiQuaterniont<T>& rotation, const Vector3t<T>& position) {
	// build a 3x3 rotation matrix
	Matrix3x3t<T> m = rotation.GetMatrix();
	...
	d3 = static_cast<T>(0.0);
	d4 = static_cast<T>(1.0);
}
...
// ----------------------------------------------------------------------------------------
template <typename T>
inline Matrix4x4t<T> Matrix4x4t<T>::operator* (const Matrix4x4t<T>& m) const {
...
// ----------------------------------------------------------------------------------------
template <typename T>
inline Matrix4x4t<T>& Matrix4x4t<T>::Transpose() {
...
// ----------------------------------------------------------------------------------------
template <typename T>
inline T Matrix4x4t<T>::Determinant() const {
...
// ----------------------------------------------------------------------------------------
template <typename T>
inline Matrix4x4t<T>& Matrix4x4t<T>::Inverse() {
...
// ----------------------------------------------------------------------------------------
template <typename T>
inline T* Matrix4x4t<T>::operator[](unsigned int p_iIndex) {
	if(p_iIndex > 3) {
		return NULL;
	}
...
// ----------------------------------------------------------------------------------------
template <typename T>
inline const T* Matrix4x4t<T>::operator[](unsigned int p_iIndex) const {
	if(p_iIndex > 3) {
		return NULL;
	}
...
// ----------------------------------------------------------------------------------------
template <typename T>
inline bool Matrix4x4t<T>::operator== (const Matrix4x4t<T>& m) const {
...
// ---------------------------------------------------------------------------
template<typename T>
inline bool Matrix4x4t<T>::Equal(const Matrix4x4t<T>& m, T epsilon) const {
	return
...
// ----------------------------------------------------------------------------------------
template <typename T>
inline void Matrix4x4t<T>::Decompose(Vector3t<T>& scaling, aiQuaterniont<T>& rotation,
	...
	rotation = aiQuaterniont<T>(m);
}

// ----------------------------------------------------------------------------------------
template <typename T>
inline void Matrix4x4t<T>::DecomposeNoScaling(aiQuaterniont<T>& rotation,
													Vector3t<T>& position) const {
	const Matrix4x4t<T>& _this = *this;
	...
	// extract rotation
	rotation = aiQuaterniont<T>((Matrix3x3t<T>)_this);
}

// ----------------------------------------------------------------------------------------
template <typename T>
inline Matrix4x4t<T>& Matrix4x4t<T>::FromEulerAnglesXYZ(const Vector3t<T>& blubb) {
	return FromEulerAnglesXYZ(blubb.x, blubb.y, blubb.z);
}

// ----------------------------------------------------------------------------------------
template <typename T>
inline Matrix4x4t<T>& Matrix4x4t<T>::FromEulerAnglesXYZ(T x, T y, T z) {
...
// ----------------------------------------------------------------------------------------
template <typename T>
inline bool Matrix4x4t<T>::IsIdentity() const {
...
template <typename T>
inline Matrix4x4t<T>& Matrix4x4t<T>::Rotation(T a, const Vector3t<T>& axis, Matrix4x4t<T>& out) {
	...
	out.a4 = out.b4 = out.c4 = static_cast<T>(0.0);
	out.d1 = out.d2 = out.d3 = static_cast<T>(0.0);
	out.d4 = static_cast<T>(1.0);
...
// ----------------------------------------------------------------------------------------
template <typename T>
inline Matrix4x4t<T>& Matrix4x4t<T>::Translation(const Vector3t<T>& v, Matrix4x4t<T>& out) {
	out = Matrix4x4t<T>();
	out.a4 = v.x;
	out.b4 = v.y;
	out.c4 = v.z;
...
// ----------------------------------------------------------------------------------------
template <typename T>
inline Matrix4x4t<T>& Matrix4x4t<T>::Scaling(const Vector3t<T>& v, Matrix4x4t<T>& out) {
	out = Matrix4x4t<T>();
	out.a1 = v.x;
	out.b2 = v.y;
	out.c3 = v.z;
 ...
 */
 // ----------------------------------------------------------------------------------------
template <typename T>
inline Matrix4x4t<T>& Matrix4x4t<T>::FromToMatrix(const Vector3t<T>& from, const Vector3t<T>& to, Matrix4x4t<T>& mtx) {
	Matrix3x3t<T> m3;

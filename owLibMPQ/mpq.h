...
/* Hash entry. All files in the archive are searched by their hashes. */
	...
	OW_LIBMPQ_DLL_API char *libmpq_version();
	OW_LIBMPQ_DLL_API int libmpq_archive_open(mpq_archive *mpq_a, unsigned char *mpq_filename);
	OW_LIBMPQ_DLL_API int libmpq_archive_close(mpq_archive *mpq_a);
	OW_LIBMPQ_DLL_API int libmpq_archive_info(mpq_archive *mpq_a, unsigned int infotype);
	//int libmpq_file_extract(mpq_archive *mpq_a, const int number);\
	/// *dest must have enough space
	OW_LIBMPQ_DLL_API int libmpq_file_getdata(mpq_archive *mpq_a, const int number, unsigned char *dest);
	OW_LIBMPQ_DLL_API int libmpq_file_info(mpq_archive *mpq_a, unsigned int infotype, const int number);
	OW_LIBMPQ_DLL_API int libmpq_file_number(mpq_archive *mpq_a, const char *name);
	OW_LIBMPQ_DLL_API int libmpq_file_number_from_hash(mpq_archive *mpq_a, unsigned int hash1, unsigned int hash2);
	OW_LIBMPQ_DLL_API int libmpq_file_check(mpq_archive *mpq_a, void *file, int type);
	OW_LIBMPQ_DLL_API int libmpq_hash_filename(mpq_archive *mpq_a, const unsigned char *pbKey, unsigned int *seed1, unsigned int*seed2);

	OW_LIBMPQ_DLL_API int libmpq_pkzip_decompress(char *out_buf, int *out_length, char *in_buf, int in_length);
	OW_LIBMPQ_DLL_API int libmpq_zlib_decompress(char *out_buf, int *out_length, char *in_buf, int in_length);
	OW_LIBMPQ_DLL_API int libmpq_huff_decompress(char *out_buf, int *out_length, char *in_buf, int in_length);
	OW_LIBMPQ_DLL_API int libmpq_wave_decompress_stereo(char *out_buf, int *out_length, char *in_buf, int in_length);
	OW_LIBMPQ_DLL_API int libmpq_wave_decompress_mono(char *out_buf, int *out_length, char *in_buf, int in_length);
	OW_LIBMPQ_DLL_API int libmpq_multi_decompress(char *out_buf, int *pout_length, char *in_buf, int in_length);
